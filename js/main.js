/* ════════════════════════════════════════════════════════════
   MIKA LIM — portfolio  ·  motion & WebGL
   ════════════════════════════════════════════════════════════ */
...
if (hasGSAP && typeof ScrollTrigger !== "undefined" && !prefersReduced) {
  ...
  // hero arch drifts slower than the page
  gsap.to(".hero-arch", {
  ...
  const material = new THREE.ShaderMaterial({
    ...
    fragmentShader: /* glsl */ `
      ...
      void main() {
        ...
        // ground the doorway with depth at its base
        col = mix(col, royal * 1.1, smoothstep(0.55, 0.0, uv.y) * 0.35);

        // glow toward the top of the doorway
